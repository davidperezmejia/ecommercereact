...
export const Home = (props) => {
    ...
    const addToCart = (product)=>{
     ...
     const [spans]=useState([
        {id: 'Alimento', text: 'Alimento'},
        {id: 'Ropaparacahorros', text: 'Ropa para cahorros'},
        {id: 'Juguetes', text: 'Juguetes'},
        {id: 'Petlovers', text: 'Pet lovers'},
    ...
    const filterFunction = (text)=>{
        if(products.length>1){
            ...
            console.log('No hay productos que filtrar')
        } 
    }
            ...
            <div className='container-fluid filter-products-main-box'>
                ...
                {filteredProducts.length < 1&&(
                    <>
                        ...
                        {products.length < 1&&(
                            <div className='my-products please-wait'>Por Favor espera un momento...</div>
                        )}
                    </>
                )}
            </div>       
